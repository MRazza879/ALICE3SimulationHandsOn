...
def buildALICE3Geometry(
    ...
    if material:
        ...
        zip_file = geo_dir / "material-map-iris4.json.zip"
        ...
        if not file.exists():
            ...
            if zip_file.exists():
                ...
                raise FileNotFoundError(f"Neither {file} nor {zip_file} exists!")
    ...
    if not tgeo_fileName.exists():
        raise FileNotFoundError(f"TGeo geometry file {tgeo_fileName} not found")
