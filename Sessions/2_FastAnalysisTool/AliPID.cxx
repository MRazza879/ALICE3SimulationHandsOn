...
//_______________________________________________________________________
AliPID::AliPID(const Double_t* probDensity, Bool_t charged) : TObject(),
                                                              fCharged(charged)
{
  //
...
//_______________________________________________________________________
AliPID::AliPID(const Float_t* probDensity, Bool_t charged) : TObject(),
                                                             fCharged(charged)
{
  //
  // Standard constructor
...
//_______________________________________________________________________
AliPID::AliPID(const AliPID& pid) : TObject(pid),
